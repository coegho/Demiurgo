...
public class LinguaxeParser extends Parser {
	...
	public static class ParensContext extends OperationContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LinguaxeListener ) ((LinguaxeListener)listener).enterParens(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LinguaxeListener ) ((LinguaxeListener)listener).exitParens(this);
		}
	}
